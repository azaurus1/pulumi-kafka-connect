...
namespace Azaurus1.Kafkaconnect
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Azaurus1.Kafkaconnect.version.txt");
    ...
    internal sealed class KafkaconnectResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KafkaconnectResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
